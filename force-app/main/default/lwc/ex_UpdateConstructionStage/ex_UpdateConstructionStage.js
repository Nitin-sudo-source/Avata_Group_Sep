...
//import Project__c from '@salesforce/schema/Construction_Stage__c.Project__c';
...
//import Tower__c from '@salesforce/schema/Construction_Stage__c.Tower__c';
import { NavigationMixin } from 'lightning/navigation';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import Cosnstructionupdate from '@salesforce/apex/Ex_ConstructionStageUpdate.Cosnstructionupdate';
//import saveAttachment from '@salesforce/apex/Ex_ConstructionStageUpdate.saveAttachment';
...
export default class Ex_UpdateConstructionStage extends NavigationMixin(LightningElement) {
          ...
          // alert('this.isError : '+ this.isError);
                if (this.selectedOption === 'Actual Completion Date') {
                   ...
                   if(!this.isError){
                    ...
                    // alert('d : '+this.date);
                    // alert('d : '+this.csId);
                    // alert('d : '+this._selected);
                    // alert('d : '+this.fileData.base64);
                    // alert('d : '+this.fileData.filename);
